document.getElementById("searchcourse-btn").addEventListener("click", function(event) {
    event.preventDefault();

    var name = document.getElementById("searchcourse-input").value;

    fetch('http://127.0.0.1:8000/course/search_course/'+name, {
  method: 'POST',
  headers: {
